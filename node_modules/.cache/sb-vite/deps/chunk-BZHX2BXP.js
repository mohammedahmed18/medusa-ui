...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-NAFUS55E.js";
import {
  ActionBar
} from "./chunk-4RADTSFH.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-CIHIL5YP.js";
import {
  require_core_events
} from "./chunk-D5X3I32I.js";
import {
  esm_default
} from "./chunk-DPULHH3L.js";
import {
  require_memoizerific
} from "./chunk-U3NCXYHI.js";
import {
  index_modern_default
} from "./chunk-2KKDPR3J.js";
import {
  curriedDarken$1,
  curriedLighten$1,
  curriedOpacify$1,
  ...
  rgba
} from "./chunk-UK2JHFHI.js";
import {
  require_pickBy
} from "./chunk-GAJR5WJM.js";
import {
  require_uniq
} from "./chunk-YELBNINO.js";
import {
  require_mapValues
} from "./chunk-OGKO5GHS.js";
import {
  require_cloneDeep
} from "./chunk-RMK4TL3U.js";
import {
  renderElement,
  unmountElement
} from "./chunk-4GKCTI7Q.js";
import {
  ...
  "../../../node_modules/tocbot/src/js/build-html.js"(exports, module) {
    module.exports = function(options2) {
      ...
      function createLink(data) {
        ...
        a.setAttribute("href", options2.basePath + "#" + data.id);
        a.setAttribute("class", options2.linkClass + SPACE_CHAR + "node-name--" + data.nodeName + SPACE_CHAR + options2.extraLinkClasses);
        item.appendChild(a);
        return item;
      }
  ...
  "../../../node_modules/tocbot/src/js/scroll-smooth/index.js"(exports) {
    ...
    function initSmoothScrolling(options2) {
      ...
      function delegatedLinkHijacking() {
        ...
        function onClick(e) {
          if (!isInPageLink(e.target) || e.target.className.indexOf("no-smooth-scroll") > -1 || e.target.href.charAt(e.target.href.length - 2) === "#" && e.target.href.charAt(e.target.href.length - 1) === "!" || e.target.className.indexOf(options2.linkClass) === -1) {
            return;
          }
          jump(e.target.hash, {
            duration,
    ...
    function jump(target, options2) {
      ...
      function easeInOutQuad(t, b2, c2, d) {
        t /= d / 2;
        if (t < 1)
          return c2 / 2 * t * t + b2;
        t--;
  ...
  Object.defineProperty(T, "__esModule", { value: true }), T.isEqual = function() {
    ...
    return function(n, a) {
      return function i(o, s, d) {
        var y, g, p, A2 = r.call(o), F = r.call(s);
        if (o === s)
          return true;
        if (o == null || s == null)
          return false;
        if (d.indexOf(o) > -1 && d.indexOf(s) > -1)
          return true;
        if (d.push(o, s), A2 != F || (y = t(o), g = t(s), y.length != g.length || y.some(function(l) {
          return !i(o[l], s[l], d);
        })))
          return false;
        switch (A2.slice(8, -1)) {
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-QOSTFSPH.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-VPFCRSY3.js"));
...
var sortFns = { alpha: (a, b2) => a.name.localeCompare(b2.name), requiredFirst: (a, b2) => {
  var _a, _b;
  return +!!((_a = b2.type) == null ? void 0 : _a.required) - +!!((_b = a.type) == null ? void 0 : _b.required) || a.name.localeCompare(b2.name);
}, none: void 0 };
...
telejson/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-BZHX2BXP.js.map
